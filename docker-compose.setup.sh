...
docker compose --env-file .combined.env -f "$COMPOSE_FILE" up -d
...
## 服务成功成功，列出相关服务信息
echo "🎉 [SUCCESS] 基础设施一键启动成功！"
echo "--------------------------------------------------"
echo "🖥️  Consul 访问地址: http://localhost:8500"
echo "🐘 SqlDb  运行端口: 5432"
echo "💾 Redis  运行端口: 6379"
echo "--------------------------------------------------"